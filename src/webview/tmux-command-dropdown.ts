...
const commands: TmuxCommand[] = [
  ...
  },
  {
    ...
    buildMessage: () => ({
      type: "executeTmuxCommand",
      commandId: "ost.tmuxSelectWindow",
    }),
  },
  {
    id: "kill-window",
  ...
  },
  {
    ...
    buildMessage: () => ({
      type: "executeTmuxCommand",
      commandId: "ost.tmuxSplitPaneWithCommand",
    }),
  },
  {
    id: "send-text",
    ...
    buildMessage: () => ({
      type: "executeTmuxCommand",
      commandId: "ost.tmuxSendTextToPane",
    }),
  },
  {
    id: "resize-pane",
